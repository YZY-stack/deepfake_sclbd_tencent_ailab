...
class Trainer(): 
    ...
    def optimize_weight_mse(
        ...
        return loss_reconstruction_1, loss_reconstruction_2, loss_reconstruction_3, \
               loss_reconstruction_4, loss_reconstruction_5, loss_reconstruction_6, \
               None
    ...
    def optimize_weight_discriminator(
        ...
        data = torch.cat((self.input, reconstruction_image_2, reconstruction_image_1), dim=0)
